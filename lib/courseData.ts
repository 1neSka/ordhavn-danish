    ...
    missions: [
      {
        ...
        questions: [
          choice("l09-m01-q01", "Vælg den mest høflige måde at bede en nabo skrue ned.", "Kunne du måske skrue lidt ned efter klokken ti?", ["Du larmer altid.", "Kunne du måske skrue lidt ned efter klokken ti?", "Stop musikken med det samme."], "Brug datid af kunne som høflig afstand.", "Kunne du måske …? gør anmodningen tydelig uden at gøre personen til problemet.", "Не могли бы вы немного убавить звук после десяти?", "pragmatik", ["høflighed", "anmodning"], 2),
          order("l09-m01-q02", "Byg det indirekte spørgsmål.", "Ved du, hvornår bussen kommer?", ["bussen", "du,", "kommer?", "Ved", "hvornår"], "Efter hvornår er rækkefølgen subjekt + verbum.", "Et indirekte spørgsmål har ikke inversion i den indlejrede del: hvornår bussen kommer.", "Ты знаешь, когда придёт автобус?", "indirekte spørgsmål", ["hv-ord", "ordstilling"], 3),
          ikkePosition("l09-m01-q03", "Byg den høflige forklaring.", "Jeg ved ikke, om det passer dig.", ["om", "passer", "Jeg", "dig.", "ved", "det", "ikke,"], "main", "Ikke står efter ved i hovedsætningen.", "Jeg ved ikke er hovedsætningen; om det passer dig er et indirekte ja/nej-spørgsmål.", "Я не знаю, подходит ли тебе это.", 3),
          input("l09-m01-q04", "Udfyld: Jeg er ked ___, at jeg afbrød dig.", "af det", ["af det", "Af det"], "Fast udtryk før en at-sætning.", "At være ked af det betyder her at være sorry, ikke nødvendigvis trist.", "Мне жаль, что я тебя перебил(а).", "reparation", ["fast udtryk", "undskyldning"], 2),
          choice("l09-m01-q05", "Hvilket svar viser uenighed uden at afvise personen?", "Jeg kan godt følge dig, men jeg ser risikoen anderledes.", ["Det giver ingen mening.", "Jeg kan godt følge dig, men jeg ser risikoen anderledes.", "Du tager helt fejl."], "Anerkend først det forståelige punkt.", "Formuleringen skelner mellem personens perspektiv og din vurdering af sagen.", "Я понимаю твою логику, но иначе вижу риск.", "uenighed", ["nuance", "samtale"], 3),
          order("l09-m01-q06", "Byg en reparation efter en misforståelse.", "Det var ikke sådan, jeg mente det.", ["mente", "sådan,", "Det", "jeg", "ikke", "var", "det."], "Start med Det var ikke sådan.", "Udtrykket korrigerer fortolkningen uden at benægte, at ordene kunne misforstås.", "Я не это имел(а) в виду.", "reparation", ["ikke", "sådan"], 2),
          input("l09-m01-q07", "Skriv bindeordet: Jeg siger det, ___ vi kan undgå samme fejl.", "så", ["så", "Så"], "Anden del udtrykker formålet/resultatet.", "Så kan forbinde handlingen med det ønskede resultat; så vi kan … er almindeligt talesprog.", "Я говорю это, чтобы мы могли избежать той же ошибки.", "sammenhæng", ["formål", "så"], 2),
          choice("l09-m01-q08", "Hvad antyder “Det er ikke helt optimalt” typisk?", "En forholdsvis tydelig negativ vurdering", ["Stor begejstring", "En forholdsvis tydelig negativ vurdering", "At alt er neutralt"], "Dansk kritik bliver ofte nedtonet sprogligt.", "Ikke helt optimalt lyder mildt, men bruges ofte som klar kritik i professionel sammenhæng.", "Это не совсем оптимально — обычно довольно явная критика.", "underdrivelse", ["pragmatik", "arbejdssprog"], 3),
        ],
      },
      {
        ...
        questions: [
          choice("l09-m02-q01", "Hvad betyder “senest den 14. august” ?", "Ikke senere end den 14. august", ["Efter den 14. august", "Præcis klokken 14", "Ikke senere end den 14. august"], "Senest angiver den sidste accepterede tid.", "Datoen er inkluderet, medmindre brevet siger andet.", "Не позднее 14 августа.", "myndighedssprog", ["frist", "senest"], 2),
          input("l09-m02-q02", "Udfyld: Du skal vedlægge dokumentation ___ din indkomst.", "for", ["for", "For"], "Man dokumenterer noget; navneordet tager ofte for.", "Den faste administrative forbindelse er dokumentation for noget.", "Нужно приложить подтверждение дохода.", "myndighedssprog", ["præposition", "dokumentation"], 2),
          order("l09-m02-q03", "Byg et præcist spørgsmål til sagsbehandleren.", "Kan du bekræfte, hvilke dokumenter der mangler?", ["der", "du", "dokumenter", "Kan", "bekræfte,", "mangler?", "hvilke"], "I en relativlignende hv-ledsætning står der før verbet.", "Hvilke dokumenter der mangler er et indirekte spørgsmål uden inversion.", "Можете подтвердить, каких документов не хватает?", "indirekte spørgsmål", ["myndighed", "der"], 3),
          choice("l09-m02-q04", "Brevet siger: “Hvis vi ikke hører fra dig, træffer vi afgørelse på det foreliggende grundlag.” Hvad sker der?", "Sagen afgøres ud fra de oplysninger, kommunen allerede har", ["Sagen slettes automatisk", "Du vinder automatisk", "Sagen afgøres ud fra de oplysninger, kommunen allerede har"], "Foreliggende betyder allerede tilgængeligt.", "Myndigheden fortsætter uden de manglende oplysninger; det er derfor vigtigt at reagere.", "Решение примут по уже имеющимся данным.", "læseforståelse", ["betingelse", "myndighed"], 3),
          ikkePosition("l09-m02-q05", "Byg betingelsen fra brevet.", "Hvis du ikke sender bilaget, kan sagen blive forsinket.", ["kan", "bilaget,", "Hvis", "blive", "sagen", "du", "forsinket.", "ikke", "sender"], "subordinate", "I hvis-leddet står ikke før sender.", "Efter den indledende ledsætning kommer inversion i hovedsætningen: kan sagen.", "Если вы не отправите приложение, дело может задержаться.", 3),
          definiteness("l09-m02-q06", "Vælg den administrative bestemte frase: «необходимый документ».", "det nødvendige dokument", { indefinite: "et dokument", definite: "dokumentet", modified: "det nødvendige dokument" }, "modified", "Dokument er et-ord.", "Foran et bestemt et-ord står det, og adjektivet får -e.", "необходимый документ", 3),
          input("l09-m02-q07", "Skriv ét ord: Du kan søge om ___, hvis fristen er umulig at nå.", "udsættelse", ["udsættelse", "Udsættelse"], "Det betyder mere tid før fristen.", "At søge om udsættelse er at bede om, at fristen flyttes.", "Можно попросить об отсрочке.", "myndighedssprog", ["frist", "navneord"], 3),
          choice("l09-m02-q08", "Hvilken afslutning passer til en formel mail?", "På forhånd tak for hjælpen.", ["Skynd dig lige.", "På forhånd tak for hjælpen.", "Nå, men vi ses."], "Tak for den hjælp, du forventer.", "På forhånd tak er en neutral, formel afslutning på en konkret anmodning.", "Заранее спасибо за помощь.", "register", ["formel mail", "høflighed"], 2),
        ],
      },
      {
        ...
        questions: [
          choice("l09-m03-q01", "Hvilket ord viser, at du ikke selv så hændelsen?", "angiveligt", ["pludselig", "angiveligt", "heldigvis"], "Det betyder ifølge det, man siger.", "Angiveligt markerer, at oplysningen kommer fra en anden kilde og ikke er bekræftet af taleren.", "предположительно / как сообщается", "kildemarkering", ["evidentialitet", "adverbium"], 3),
          order("l09-m03-q02", "Byg en neutral kildemarkering.", "Ifølge vidnet kørte bilen for hurtigt.", ["bilen", "Ifølge", "for", "vidnet", "hurtigt.", "kørte"], "Kildeleddet står først, så kommer verbet.", "Ifølge vidnet fylder første plads; V2 giver kørte bilen.", "По словам свидетеля, машина ехала слишком быстро.", "kildemarkering", ["ifølge", "V2"], 3),
          input("l09-m03-q03", "Udfyld rækkefølgen: Først ringede jeg. ___ ventede jeg udenfor.", "Derefter", ["derefter", "Derefter"], "Et tidsadverbium, der betyder bagefter.", "Derefter binder hændelserne sammen og udløser inversion: ventede jeg.", "Затем я ждал(а) снаружи.", "fortællestruktur", ["rækkefølge", "V2"], 2),
          choice("l09-m03-q04", "Hvilken sætning skelner tydeligt mellem observation og gæt?", "Jeg så røg, men jeg ved ikke, hvor den kom fra.", ["Der var helt sikkert brand.", "Jeg så røg, men jeg ved ikke, hvor den kom fra.", "Alt var nok farligt."], "Fortæl først det sansede, derefter grænsen.", "Sætningen hævder kun den direkte observation og markerer det ukendte eksplicit.", "Я видел(а) дым, но не знаю, откуда он шёл.", "præcision", ["observation", "usikkerhed"], 3),
          ikkePosition("l09-m03-q05", "Byg ledsætningen med korrekt placering.", "selvom politiet endnu ikke har bekræftet årsagen", ["årsagen", "endnu", "politiet", "har", "selvom", "bekræftet", "ikke"], "subordinate", "Sætningsadverbierne kommer før har.", "I ledsætningen står subjekt + endnu ikke + hjælpeverbum.", "хотя полиция ещё не подтвердила причину", 3),
          order("l09-m03-q06", "Byg en sammenhængende kontrast.", "På den ene side var vejen glat, men på den anden side kørte han for stærkt.", ["stærkt.", "ene", "kørte", "På", "men", "han", "glat,", "den", "på", "side", "den", "for", "side", "anden", "var", "vejen"], "Brug de to faste side-udtryk.", "Konstruktionen vejer to forklaringer mod hinanden uden at gøre dem ens.", "С одной стороны, дорога была скользкой, но с другой — он ехал слишком быстро.", "nuancering", ["kontrast", "argumentation"], 3),
          input("l09-m03-q07", "Skriv participiet: Hændelsen er blevet ___ af flere aviser. (omtale)", "omtalt", ["omtalt", "Omtalt"], "Blive + kort tillægsform danner passiv.", "Er blevet omtalt er perfektum passiv: hændelsen har fået omtale.", "Событие освещалось несколькими газетами.", "passiv", ["blive-passiv", "medier"], 3),
          choice("l09-m03-q08", "Vælg den bedste opsummering, når årsagen stadig undersøges.", "Forløbet er kendt, men årsagen er endnu uafklaret.", ["Ingen ved noget som helst.", "Årsagen er helt sikkert teknisk.", "Forløbet er kendt, men årsagen er endnu uafklaret."], "Adskil det kendte fra det ukendte.", "Uafklaret beskriver præcist en konklusion, der endnu ikke kan drages.", "Ход событий известен, но причина пока не установлена.", "opsummering", ["usikkerhed", "medier"], 3),
        ],
      },
    ],
  },
    ...
    missions: [
      {
        ...
        questions: [
          choice("l10-m01-q01", "Hvilken formulering udtrykker den stærkeste sikkerhed?", "Tallene dokumenterer, at udgiften er faldet.", ["Tallene kunne tyde på et fald.", "Tallene dokumenterer, at udgiften er faldet.", "Det lader til, at udgiften måske er faldet."], "Dokumenterer hævder direkte bevis.", "Kun dokumenterer præsenterer sammenhængen som bevist; kunne tyde på og lader til er forbehold.", "Цифры подтверждают снижение расходов.", "modalitet", ["sikkerhed", "kilder"], 3),
          order("l10-m01-q02", "Byg et præcist forbehold.", "Resultatet gælder kun, for så vidt som stikprøven er repræsentativ.", ["repræsentativ.", "vidt", "kun,", "Resultatet", "stikprøven", "gælder", "som", "er", "for", "så"], "Brug den faste forbindelse for så vidt som.", "For så vidt som afgrænser påstandens gyldighed til en bestemt betingelse.", "Результат применим лишь постольку, поскольку выборка репрезентативна.", "akademisk dansk", ["forbehold", "betingelse"], 3),
          input("l10-m01-q03", "Udfyld: Det kan ikke udelukkes, ___ ændringen skyldes sæsonen.", "at", ["at", "At"], "En hel påstand følger efter udtrykket.", "Det kan ikke udelukkes, at … er en formel måde at markere en reel mulighed uden at hævde den.", "Нельзя исключить, что изменение сезонное.", "modalitet", ["formelt register", "usikkerhed"], 3),
          choice("l10-m01-q04", "Hvilken skjult antagelse ligger i “Selv eksperterne tog fejl” ?", "Man forventede især, at eksperterne havde ret", ["Ingen forventede noget af eksperterne", "Man forventede især, at eksperterne havde ret", "Kun eksperter kan tage fejl"], "Selv markerer et uventet medlem af gruppen.", "Fokuspartiklen selv bygger på forventningen om, at eksperter er mindre tilbøjelige til at tage fejl.", "Даже эксперты ошиблись — ожидалось, что именно они будут правы.", "pragmatik", ["presupposition", "selv"], 3),
          ikkePosition("l10-m01-q05", "Byg den komplekse indrømmelse.", "Selvom metoden ikke nødvendigvis er forkert, er datagrundlaget for smalt.", ["for", "metoden", "forkert,", "Selvom", "smalt.", "nødvendigvis", "er", "datagrundlaget", "ikke", "er"], "subordinate", "I selvom-leddet kommer ikke nødvendigvis før er.", "Indrømmelsen kritiserer ikke metoden direkte; hovedpåstanden rammer datagrundlaget.", "Хотя метод не обязательно неверен, данных слишком мало.", 3),
          choice("l10-m01-q06", "Hvad gør ordet “tilsyneladende” i en rapport?", "Det markerer, at noget ser sådan ud, men ikke er endeligt bevist", ["Det gør påstanden juridisk sikker", "Det markerer, at noget ser sådan ud, men ikke er endeligt bevist", "Det gør påstanden ironisk"], "Tænk på det, der er synligt på overfladen.", "Tilsyneladende er en evidensmarkør, der reserverer mulighed for en anden forklaring.", "По-видимому — так выглядит, но не доказано окончательно.", "kildemarkering", ["adverbium", "forbehold"], 3),
          input("l10-m01-q07", "Skriv substantivet: Der er ikke belæg ___ den konklusion.", "for", ["for", "For"], "Fast forbindelse i argumentation.", "Belæg for betyder evidens, der kan bære en bestemt påstand.", "Нет оснований для такого вывода.", "argumentation", ["belæg", "præposition"], 3),
          order("l10-m01-q08", "Byg konklusionen uden at overdrive.", "Dataene peger i samme retning, men de fastslår ikke årsagen.", ["de", "retning,", "Dataene", "årsagen.", "ikke", "men", "fastslår", "peger", "samme", "i"], "Kontrastér mønster med årsag.", "At data peger i en retning er svagere end at fastslå en årsag; forskellen beskytter mod overfortolkning.", "Данные указывают в одном направлении, но не устанавливают причину.", "konklusion", ["årsag", "evidens"], 3),
        ],
      },
      {
        ...
        questions: [
          choice("l10-m02-q01", "Hvilket svar undersøger interessen bag et krav?", "Hvad er det vigtigste, den tidligere deadline skal løse?", ["Det går vi aldrig med til.", "Hvad er det vigtigste, den tidligere deadline skal løse?", "Kan vi ikke bare mødes på midten?"], "Spørg efter problemet, ikke kun positionen.", "Spørgsmålet kan afsløre en anden løsning end blot at acceptere eller afvise datoen.", "Какую главную проблему должен решить более ранний срок?", "forhandling", ["interesser", "åbent spørgsmål"], 3),
          order("l10-m02-q02", "Byg et betinget tilbud.", "Hvis I kan garantere volumen, kan vi reducere prisen med otte procent.", ["otte", "prisen", "Hvis", "reducere", "kan", "I", "kan", "med", "procent.", "garantere", "vi", "volumen,"], "Betingelsen står først; hovedsætningen får inversion.", "Tilbuddet kobler indrømmelsen til en konkret modydelse og gør aftalen målbar.", "Если вы гарантируете объём, мы снизим цену на восемь процентов.", "forhandling", ["betingelse", "V2"], 3),
          input("l10-m02-q03", "Udfyld: Det forslag imødekommer vores behov ___ sikkerhed.", "for", ["for", "For"], "Behov tager ofte for foran det ønskede.", "Et behov for noget er den normale substantivforbindelse.", "Это предложение отвечает нашей потребности в надёжности.", "forhandling", ["fast præposition", "behov"], 2),
          choice("l10-m02-q04", "Hvilken formulering afviser et forslag, men holder forhandlingen åben?", "Den model kan vi ikke godkende som den står, men vi kan arbejde videre med risikodelingen.", ["Aldrig i livet.", "Den model kan vi ikke godkende som den står, men vi kan arbejde videre med risikodelingen.", "Det lyder fint nok."], "Afvis den konkrete model, og navngiv et arbejdsområde.", "Som den står begrænser afvisningen; anden del viser en specifik vej frem.", "В нынешнем виде мы не можем одобрить модель, но готовы доработать распределение рисков.", "forhandling", ["afvisning", "kompromis"], 3),
          ikkePosition("l10-m02-q05", "Byg reservationen korrekt.", "Vi accepterer tilbuddet, hvis leveringen ikke bliver forsinket igen.", ["igen.", "accepterer", "ikke", "Vi", "leveringen", "tilbuddet,", "bliver", "hvis", "forsinket"], "subordinate", "I hvis-leddet står ikke før bliver.", "Betingelsen er en ledsætning og følger subjekt + ikke + finit verbum.", "Мы принимаем предложение, если поставка снова не задержится.", 3),
          choice("l10-m02-q06", "Hvad betyder “Det er et udgangspunkt, ikke et ultimatum” ?", "Forslaget kan stadig forhandles", ["Forslaget er allerede endeligt", "Forslaget kan stadig forhandles", "Forslaget trækkes tilbage"], "Et udgangspunkt er stedet, man starter.", "Kontrasten sænker presset og inviterer til modforslag.", "Это отправная точка, а не ультиматум.", "forhandling", ["pragmatik", "rammesætning"], 2),
          order("l10-m02-q07", "Byg en fair opsummering af uenigheden.", "Vi er enige om målet, men uenige om, hvem der bærer risikoen.", ["om,", "men", "risikoen.", "målet,", "uenige", "der", "Vi", "hvem", "er", "om", "bærer", "enige"], "Skeln mellem fælles mål og uafklaret ansvar.", "En præcis opsummering gør konflikten mindre personlig og viser, hvad der faktisk skal løses.", "Мы согласны с целью, но не с тем, кто несёт риск.", "opsummering", ["uenighed", "relativsætning"], 3),
          input("l10-m02-q08", "Skriv ordet: Aftalen træder i kraft under ___ af bestyrelsens godkendelse.", "forudsætning", ["forudsætning", "Forudsætning"], "Det betyder på betingelse af.", "Under forudsætning af gør godkendelsen til en nødvendig betingelse for aftalens virkning.", "Соглашение вступает в силу при условии одобрения советом.", "formelt register", ["betingelse", "aftale"], 3),
        ],
      },
      {
        ...
        questions: [
          choice("l10-m03-q01", "En kommune vil lukke et bibliotek med få daglige besøgende. Hvilket argument er mest analytisk?", "Besøgstallet er relevant, men bør vejes mod adgang, alternativer og bibliotekets sociale funktion.", ["Få gæster betyder altid, at stedet er værdiløst.", "Biblioteker må aldrig ændres.", "Besøgstallet er relevant, men bør vejes mod adgang, alternativer og bibliotekets sociale funktion."], "Inddrag både mål og konsekvenser.", "Svaret accepterer dataens relevans uden at gøre én måling til hele beslutningen.", "Посещаемость важна, но её следует сопоставить с доступностью, альтернативами и социальной ролью.", "argumentation", ["afvejning", "samfund"], 3),
          order("l10-m03-q02", "Byg en kausal reservation.", "At to ændringer sker samtidig, betyder ikke nødvendigvis, at den ene skyldes den anden.", ["at", "skyldes", "sker", "den", "nødvendigvis,", "betyder", "ændringer", "anden.", "ikke", "samtidig,", "At", "to", "ene", "den"], "Samtidighed er ikke automatisk årsag.", "Sætningen skelner korrelation fra kausalitet med nødvendigvis som styrkemarkør.", "То, что два изменения происходят одновременно, не означает, что одно вызвано другим.", "kritisk tænkning", ["kausalitet", "korrelation"], 3),
          input("l10-m03-q03", "Udfyld: Fordelene skal ses i ___ af de langsigtede omkostninger.", "lyset", ["lyset", "Lyset"], "Fast metafor: i ___ af.", "At se noget i lyset af betyder at vurdere det med en bestemt kontekst som baggrund.", "Преимущества нужно рассматривать в свете долгосрочных затрат.", "argumentation", ["fast udtryk", "afvejning"], 3),
          choice("l10-m03-q04", "Hvilken sætning gengiver en modparts synspunkt fair?", "Kritikerne frygter især, at besparelsen flytter udgiften til andre tilbud.", ["Kritikerne hader tydeligvis forandring.", "Kritikerne frygter især, at besparelsen flytter udgiften til andre tilbud.", "Kritikerne forstår ikke økonomi."], "Gengiv deres stærkeste konkrete bekymring.", "Sætningen beskriver et efterprøvbart konsekvensargument uden at tillægge modparten dårlige motiver.", "Критики прежде всего опасаются переноса расходов на другие службы.", "argumentation", ["steelman", "modargument"], 3),
          ikkePosition("l10-m03-q05", "Byg indrømmelsen med korrekt ordstilling.", "Selv hvis besparelsen ikke er stor, kan signalværdien være betydelig.", ["stor,", "Selv", "signalværdien", "betydelig.", "besparelsen", "ikke", "kan", "hvis", "være", "er"], "subordinate", "I selv hvis-leddet står ikke før er.", "Indrømmelsen accepterer en lille direkte effekt, mens hovedsætningen peger på en anden type effekt.", "Даже если экономия невелика, символическое значение может быть существенным.", 3),
          choice("l10-m03-q06", "Hvad er forskellen på “effektiv” og “effektfuld” i en beslutning?", "Effektiv handler om ressourcebrug; effektfuld om stærk virkning", ["De betyder altid præcis det samme", "Effektiv handler om ressourcebrug; effektfuld om stærk virkning", "Effektiv er negativ; effektfuld er positiv"], "Det ene måler middel, det andet virkning.", "En løsning kan være billig og effektiv uden at have stor effekt — eller omvendt.", "Эффективный — про ресурсы; действенный — про силу результата.", "ordforråd", ["præcision", "falske venner"], 3),
          order("l10-m03-q07", "Byg den endelige anbefaling.", "Jeg anbefaler en prøveperiode, fordi den gør beslutningen reversibel og skaber bedre data.", ["den", "prøveperiode,", "bedre", "fordi", "en", "anbefaler", "data.", "reversibel", "Jeg", "beslutningen", "gør", "og", "skaber"], "Giv både handling og begrundelse.", "En prøveperiode reducerer usikkerhed, fordi den kan rulles tilbage og samtidig producerer ny evidens.", "Я рекомендую испытательный период: решение можно отменить и собрать лучшие данные.", "anbefaling", ["beslutning", "begrundelse"], 3),
          input("l10-m03-q08", "Afslut B2-rejsen: En ansvarlig konklusion er tydelig om både sit svar og sin ___.", "usikkerhed", ["usikkerhed", "Usikkerhed"], "Det modsatte af falsk sikkerhed.", "På B2 er præcision ikke kun at vide mere, men også at markere grænsen for det, man ved.", "Ответственный вывод ясен и в ответе, и в своей неопределённости.", "metakognition", ["B2", "usikkerhed"], 3),
        ],
      },
    ],
  },
